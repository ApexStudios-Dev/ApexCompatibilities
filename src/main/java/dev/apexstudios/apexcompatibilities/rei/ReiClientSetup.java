...
import dev.apexstudios.apexcompatibilities.rei.furniture.DecorationsFurnitureModuleReiClientSetup;
...
public final class ReiClientSetup implements REIClientPlugin {
    private final CompatManager<ReiClientSetup, REIClientPlugin> manager = CompatManager.create(this, builder -> builder
            ...
            .with(ApexCompatibilities.FANTASY_FURNITURE_BONE_SKELETON, () -> BoneSkeletonFurnitureSetReiClientSetup::new)
            .with(ApexCompatibilities.FANTASY_FURNITURE_BONE_WITHER, () -> BoneWitherFurnitureSetReiClientSetup::new)
            ...
            .with(ApexCompatibilities.FANTASY_FURNITURE_DECORATIONS, () -> DecorationsFurnitureModuleReiClientSetup::new)
    );
