...
public final class JeiSetup implements IModPlugin {
    private final CompatManager<JeiSetup, IModPlugin> manager = CompatManager.create(this, builder -> builder
            ...
            .owned(ApexCompatibilities.FANTASY_FURNITURE_BONE_SKELETON, () -> BoneSkeletonFurnitureSetJeiPlugin::new)
            .owned(ApexCompatibilities.FANTASY_FURNITURE_BONE_WITHER, () -> BoneWitherFurnitureSetJeiPlugin::new)
    ...
    public Identifier getPluginUid() {
        return Identifier.fromNamespaceAndPath(ApexCompatibilities.ID, "jei_plugin");
    }
