...
//
//    @Override
//    public void draw(RecipeHolder<FurnitureStationRecipe> holder, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor graphics, double mouseX, double mouseY) {
