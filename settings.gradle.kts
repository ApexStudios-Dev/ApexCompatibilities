...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        ...
        library("itemresistance", "dev.apexstudios", "itemresistance").version("26.2.2-beta-pr-49")
        library("infusedfoods", "dev.apexstudios", "infusedfoods").version("26.2.2-beta-pr-52")
        library("fantasydice", "dev.apexstudios", "fantasydice").version("26.2.2-beta-pr-50")

        version("fantasyfurniture", "26.2.2-beta-pr-121")
