...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        ...
        library("fantasyfurniture", "dev.apexstudios", "fantasyfurniture").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_nordic", "dev.apexstudios", "fantasyfurniture-nordic").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_venthyr", "dev.apexstudios", "fantasyfurniture-venthyr").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_bone", "dev.apexstudios", "fantasyfurniture-bone").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_dunmer", "dev.apexstudios", "fantasyfurniture-dunmer").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_necrolord", "dev.apexstudios", "fantasyfurniture-necrolord").version("21.9.0-beta-pr-77")
        library("fantasyfurniture_royal", "dev.apexstudios", "fantasyfurniture-royal").version("21.9.0-beta-pr-77")
