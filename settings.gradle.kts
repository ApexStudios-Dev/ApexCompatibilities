...
dependencyResolutionManagement {
    versionCatalogs.create("libs") {
        ...
        library("itemresistance", "dev.apexstudios", "itemresistance").version("26.1.10-beta-pr-37")
        library("infusedfoods", "dev.apexstudios", "infusedfoods").version("26.1.10-beta-pr-40")
        library("fantasydice", "dev.apexstudios", "fantasydice").version("26.1.9-beta-pr-38")

        version("fantasyfurniture", "26.1.21-beta-pr-100")
